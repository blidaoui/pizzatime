      ...
      <div className="container-fluid align-items-center">
        ...
        >
          <div className="offcanvas-header">
            <h5 className="cart-title" id="offcanvasNavbarLabel"> your cart</h5>
            <button
              type="button"
              className="btn-close"
